    ...
    <div class="container flex-col  pl-12 pt-5">
        <div class=" flex flex-col gap-10">
            ...
            <form method="POST" class=" w-3/5 mx-auto bg-[#BC5757] rounded-3xl opacity-90 shadow-2xl p-10">
                ...
                <div class="flex justify-between items-center gap-4 ">
                    <div class="mb-3 flex-1">
                        ...
                        <input type="text" class="form-control  input input-bordered w-full max-w-xs mt-2" id="news_id"
                            name="news_id" required>
                    </div>
                    <div class="mb-3 flex-1">
                        <label for="news_title" class="form-label text-lg text-gray-900 font-semibold">News
                            Title</label>
                ...
                <div class="flex justify-between items-center gap-4 ">
                    <div class="mb-3 flex-1">
                        ...
                        <input type="url" class="form-control input input-bordered w-full max-w-xs mt-2" id="news_link"
                            name="news_link" required>
                    </div>
                    <div class="mb-3 flex-1">
                        <label for="news_img" class="form-label text-lg text-gray-900 font-semibold">Image URL</label>
                        <input type="url" class="form-control input input-bordered w-full max-w-xs mt-2" id="news_img"
                            name="news_img" required>
                    </div>

                </div>
                <div class="mb-3">
                    <label for="news_content" class="form-label text-lg text-gray-900 font-semibold">Content</label>
                    <textarea class="form-control input input-bordered w-full mt-2" id="news_content"
            ...
            <form method="POST" class="w-3/5 mx-auto bg-[#BC5757] rounded-3xl opacity-90 shadow-2xl p-10">
                ...
                <div class="flex justify-between items-center gap-4 ">
                    <div class="mb-3 flex-1">
                        <label for="update_id" class="form-label text-lg text-gray-900 font-semibold">News ID to
                            Update</label>
                        <input type="text" class="form-control input input-bordered w-full max-w-xs mt-2" id="update_id"
                            name="update_id" required>
                    </div>
                    <div class="mb-3 flex-1">
                        <label for="update_title" class="form-label text-lg text-gray-900 font-semibold">New News
                            Title</label>
                        <input type="text" class="form-control input input-bordered w-full max-w-xs mt-2"
                            id="update_title" name="update_title" required>
                    </div>
                </div>
                <div class="flex justify-between items-center gap-4 ">
                    <div class="mb-3 flex-1">
                        ...
                        <input type="url" class="form-control input input-bordered w-full max-w-xs mt-2"
                            id="update_link" name="update_link" required>
                    </div>

                    <div class="mb-3 flex-1">
                        <label for="update_img" class="form-label text-lg text-gray-900 font-semibold">New Image
                            URL</label>
                        <input type="url" class="form-control input input-bordered w-full max-w-xs mt-2" id="update_img"
                            name="update_img" required>
                    </div>


                </div>
                <div class="mb-3">
                    <label for="news_content" class="form-label text-lg text-gray-900 font-semibold">New Content</label>
                    <textarea class="form-control input input-bordered w-full mt-2" id="news_content"
                        name="news_content" required></textarea>
                </div>
                <div class="flex justify-center items-center">
            ...
            <form method="POST" class="w-3/5 mx-auto bg-[#BC5757] rounded-3xl opacity-90 shadow-2xl p-10">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control input input-bordered w-full mt-2" id="delete_id"
